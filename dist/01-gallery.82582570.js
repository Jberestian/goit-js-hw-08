...
},{"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"css/01-gallery.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');
...
function makeGalleryCard() {
  return _galleryItems.galleryItems.map(el => `<a class="gallery__item" href="${el.original}">
        <img class="gallery__image" src="${el.preview}" alt="${el.description}" />
        </a>`).join('');
}

galleryEl.insertAdjacentHTML('afterbegin', makeGalleryCard(_galleryItems.galleryItems));
let lightbox = new _simplelightbox.default('.gallery a', {
  captionsData: 'alt',
  captionDelay: 250
});
console.log(_galleryItems.galleryItems);
},{"./gallery-items":"js/gallery-items.js","simplelightbox":"../node_modules/simplelightbox/dist/simple-lightbox.modules.js","simplelightbox/dist/simple-lightbox.min.css":"../node_modules/simplelightbox/dist/simple-lightbox.min.css","../css/01-gallery.css":"css/01-gallery.css","../css/common.css":"css/common.css"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
